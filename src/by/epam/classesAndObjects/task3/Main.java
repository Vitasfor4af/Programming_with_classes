...
public class Main {
	...
	public static void main(String[] args) {
		...
		student[2] = new Student("Renat", "V. Z.", 10902311, 7);
		student[3] = new Student("Kasperovich", "E. S.", 10902118, 6);
		student[4] = new Student("Avdechik", "V. S.", 10904516, 7);
		student[5] = new Student("Vinogradova", "M. K.", 10905612, 9);
		student[6] = new Student("Rajko", "A. O.", 10702617, 6);
		student[7] = new Student("Morozov", "P. I.", 10301116, 4);
		student[8] = new Student("Erema", "Z. D.", 10405715, 10);
